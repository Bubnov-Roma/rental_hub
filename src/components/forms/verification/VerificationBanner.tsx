			...
			<div className="relative glass-container rounded-[31px] p-6 sm:p-8 overflow-hidden bg-black/40 backdrop-blur-3xl">
				...
				<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
					<div className="flex items-start gap-5">
						<div className="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-400 border border-blue-500/20 shadow-[0_0_20px_rgba(59,130,246,0.2)]">
							<ShieldCheck size={32} />
						</div>
						<div className="space-y-1">
							...
							<p className="text-white/60 max-w-120 text-sm sm:text-base">
								Заполните анкету клиента один раз, чтобы арендовать любое
								оборудование без внесения страхового депозита. Проверка займет
								около 15 минут.
							</p>
						</div>
					</div>
