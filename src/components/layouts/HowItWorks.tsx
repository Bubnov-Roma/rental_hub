...
export function HowItWorks() {
	return (
		<section className="py-16 bg-linear-to-b to-gray-50">
			<div className="container mx-auto px-4">
				...
				<div className="relative">
					{/* Линия соединения */}
					<div className="absolute left-1/2 top-12 h-full w-0.5 -translate-x-1/2 bg-linear-to-b from-blue-100 to-purple-700 md:left-1/2"></div>
							...
							<div key={step.title} className="relative">
								<div className="flex flex-col items-center text-center">
									<div className="relative mb-4">
										<div className="flex h-16 w-16 items-center justify-center rounded-full bg-linear-to-br from-blue-100 to-purple-300">
				...
				<div className="mt-16 text-center">
					<div className="inline-flex items-center gap-2 rounded-full bg-green-50 px-6 py-3 drop-shadow-xl">
