...
const steps = [
	{
		...
		title: "Быстрый поиск",
		desc: "Найдите нужное оборудование по названию. Используйте фильтры по категориям, брендам и цене.",
	},
	{
		icon: CreditCardIcon,
		title: "Удобное бронирование",
		desc: "Добавьте выбранную технику в корзину или оформляйте 'быструю бронь' прямо на странице товара.",
	},
	{
		icon: CalendarCheckIcon,
		title: "Доступность онлайн",
		desc: "Выбирите удобные даты и время для аренды. Календарь покажет актуальную доступность для каждого товара.",
	},
	{
		icon: PackageIcon,
		title: "Получение заказа",
		desc: "Мы свяжемся с вами чтобы подтвердить заказ, проверим и подготовим всё оборудование к вашему приезду.",
	},
	{
		icon: StarIcon,
		title: "Возврат и оценка",
		desc: "Верните заказа по завершению съемок и оцените наш сервис. Мы дорожим каждым клиентом и дарим скидки за активность.",
	},
];
